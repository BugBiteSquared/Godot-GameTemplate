...
func _ready()->void:
  ...
  MenuEvent.connect("Controls",Callable(self,"on_show_controls"))
  MenuEvent.connect("Languages",Callable(self,"on_show_languages"))
  SettingsResolution.connect("Resized",Callable(self,"_on_Resized"))
  #Localization
...
func _on_Fullscreen_pressed()->void:
  SettingsResolution.Fullscreen = find_child("Fullscreen").pressed

func _on_Borderless_pressed()->void:
  SettingsResolution.Borderless = find_child("Borderless").pressed

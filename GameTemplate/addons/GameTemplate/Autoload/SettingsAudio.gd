...
var VolumeMaster:float = 0.0 :
	get:
		return VolumeMaster # TODOConverter40 Non existent get function 
	set(mod_value):
		mod_value  # TODOConverter40 Copy here content of set_volume_master
var VolumeMusic:float = 0.0 :
	get:
		return VolumeMusic # TODOConverter40 Non existent get function 
	set(mod_value):
		mod_value  # TODOConverter40 Copy here content of set_volume_music
var VolumeSFX:float = 0.0 :
	get:
		return VolumeSFX # TODOConverter40 Non existent get function 
	set(mod_value):
		mod_value  # TODOConverter40 Copy here content of set_volume_sfx
